...
class Customer(AbstractUser): 
    ...
    # 사용자 대표 이미지
    user_image = models.ImageField(upload_to="account/profile_image", default="account/profile_image/user_default_image.png", blank=True, null=False, verbose_name="프로필 이미지")
