...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('portfolio_image', models.ImageField(upload_to='tattooistApp/portfolio_image', verbose_name='포트폴리오 사진')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_image', models.ImageField(blank=True, default='tattoistApp/review_image/default_review_image.png', upload_to='tattooistApp/review_image', verbose_name='리뷰 사진')),
