...
urlpatterns = [
    ...
    # path("message/<int:tattooist_id>between<int:customer_id>", views.message_view, name="message"),
    path("message/<int:receiver_id>between<int:sender_id>", views.message_view, name="message"),
